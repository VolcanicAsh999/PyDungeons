...
import dungeon_game
import dungeon_logger as logger  # imports (dungeon_settings is actually not needed yet... TODO: comment it/figure out a use)
...
def main():
    ...
    dungeon_game.main(options)  # pass the options to dungeons_game (which does pretty much everything, but weird logs pop up if we run it directly)
